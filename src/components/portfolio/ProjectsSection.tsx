...
const projects = [
  {
    "title": "汉字学 HanZiXue – Offline Chinese Flashcards",
    ...
    "methodology": "HanZiXue was built using a Minimal Viable Product (MVP) approach with rapid iteration. It follows an offline-first design powered by localStorage for persistence. The mobile-first UI includes automatic dark mode and a smooth 3D card flip created with pure CSS. \nLevel filtering (HSK 1/2/3/All) and due-card prioritization optimize daily reviews. Development was iterative with frequent testing on real mobile devices to ensure offline functionality, touch support, and speech synthesis reliability.",
    "outcomes": [
